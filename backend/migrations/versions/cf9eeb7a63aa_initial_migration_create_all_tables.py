...
def upgrade() -> None:
    ...
    op.execute('DROP TYPE IF EXISTS attributetype CASCADE')
    op.execute('DROP TYPE IF EXISTS commissiontype CASCADE')
...
def downgrade() -> None:
    ...
    # Drop notifications and fcm_tokens before orders (they have foreign keys to orders/users)
    ...
    # Drop PostgreSQL ENUM types (they persist even after tables are dropped)
    op.execute('DROP TYPE IF EXISTS attributetype CASCADE')
    op.execute('DROP TYPE IF EXISTS commissiontype CASCADE')
    op.execute('DROP TYPE IF EXISTS userrole CASCADE')
    op.execute('DROP TYPE IF EXISTS orderstatus CASCADE')
