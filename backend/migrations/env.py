...
from app.core.database import Base, normalize_database_url, get_connect_args

# Import all models so Alembic can detect them
from app.models import (
    User, UserRole, Category, Attribute, AttributeValue, 
    ...
    Notification, NotificationType, FCMToken, Banner, BannerPosition, BannerStatus
)
...
def run_migrations_online() -> None:
    ...
    """
    # Create engine directly with SSL support for PostgreSQL
