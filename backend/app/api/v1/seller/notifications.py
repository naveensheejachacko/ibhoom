...
async def get_notifications(
    ...
    """Get seller notifications (Seller only)"""
...
async def get_unread_count(
    ...
    """Get count of unread notifications (Seller only)"""
...
async def mark_notification_read(
    ...
    """Mark a notification as read (Seller only)"""
...
async def mark_all_read(
    ...
    """Mark all notifications as read (Seller only)"""
